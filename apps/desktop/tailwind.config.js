...
export default {
  ...
  theme: {
    extend: {
      fontFamily: {
        // Resolves through the per-script stack defined in styles.css so
        // `font-sans` picks up CJK / Devanagari coverage with the UI language.
        sans: ['var(--fc-font-ui)', 'Inter', 'system-ui', 'sans-serif'],
        mono: ['JetBrains Mono', 'ui-monospace', 'SFMono-Regular', 'monospace'],
      },
      colors: {
        // The scale reads its values from CSS variables so the light theme
        // is a variable swap in styles.css (`html[data-theme='light']`)
        // rather than a `dark:` variant on every component. `<alpha-value>`
        // keeps `bg-surface-900/40`-style opacity modifiers working.
        surface: {
          ...
          850: 'rgb(var(--sf-850) / <alpha-value>)',
          900: 'rgb(var(--sf-900) / <alpha-value>)',
          950: 'rgb(var(--sf-950) / <alpha-value>)',
        },
        accent: {
          500: '#2563eb',
          600: '#1d4ed8',
        },
        // The chromatic hues follow the same variable scheme (see the
        // `--c-*` block in styles.css); the light theme remaps each shade
        // there, so components keep writing dark-theme classes only.
        red: {
