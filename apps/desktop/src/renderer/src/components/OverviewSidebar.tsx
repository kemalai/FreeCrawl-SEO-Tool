      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              key: 'issues-page-too-large-critical',
              label: 'Critical Size (>3MB)',
              count: o.issues.pageTooLargeCritical,
              category: 'issues:page-too-large-critical',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          children: [
            ...
            {
              key: 'issues-landmark-main-missing',
              label: 'Main Landmark Missing',
              count: o.issues.landmarkMainMissing,
              category: 'issues:landmark-main-missing',
            },
            {
              key: 'issues-skip-link-missing',
              label: 'Skip Link Missing',
              count: o.issues.skipLinkMissing,
              category: 'issues:skip-link-missing',
            },
            {
              key: 'issues-aria-invalid-role',
        ...
        },
        {
          ...
          children: [
            ...
            {
              key: 'issues-schema-duplicate-id',
              label: 'Duplicate @id',
              count: o.issues.schemaDuplicateId,
              category: 'issues:schema-duplicate-id',
            },
            {
              key: 'issues-schema-unknown-type',
              label: 'Malformed @type',
              count: o.issues.schemaUnknownType,
              category: 'issues:schema-unknown-type',
            },
            {
              key: 'issues-schema-missing-required',
        ...
        },
        {
          ...
          children: [
            ...
            {
              key: 'issues-pagination-canonical-conflict',
              label: 'Canonical Conflict',
              count: o.issues.paginationCanonicalConflict,
