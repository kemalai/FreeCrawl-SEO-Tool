...
export const TAB_QUICK_FILTERS: Partial<Record<TabKey, TabQuickFilter[]>> = {
  ...
  url: [
    ...
    { label: 'Crawl Trap', category: 'issues:crawl-trap' },
  ...
  canonicals: [
    ...
    { label: 'Conflicting Canonicals', category: 'issues:canonical-conflicting' },
    { label: 'Canonical → Cross-Domain', category: 'issues:canonical-cross-domain' },
    { label: 'Noindex + Canonical Conflict', category: 'issues:noindex-canonical-conflict' },
